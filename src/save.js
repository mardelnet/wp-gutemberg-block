					...
					<div className="slider-container__featured">
						<div className="single-press-note">
							<Icon
								...
								icon={
									featuredPressNote?.selectedOption ??
									'admin-site'
								}
							/>
							<div className="main-image">
								{ featuredPressNote?.imageUrl && (
									<img
										src={ featuredPressNote.imageUrl }
										alt={
							...
							{ featuredPressNote?.title && (
								<h3 className="single-press-note__title">
									{ featuredPressNote.title }
								</h3>
							) }
							{ featuredPressNote?.content && (
								<p className="single-press-note__content">
									{ featuredPressNote.content }
								</p>
							) }
						</div>
